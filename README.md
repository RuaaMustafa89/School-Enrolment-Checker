...
The code is easy to read as it has meaningful variable names such as age, distance etc.
The program uses 'and' to check multiple conditions at once (DRY principle)
